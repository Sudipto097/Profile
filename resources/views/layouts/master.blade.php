                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('image')}}">Add Hero</a></li>
                            <li><a href="{{route('all-image')}}">All Hero</a></li>
                        </ul>
                    </li>
...
<!-- Mirrored from themesbrand.com/minible/layouts/index-dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Mar 2021 17:15:50 GMT -->
</html>
